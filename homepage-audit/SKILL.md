---
name: homepage-audit
description: Quick conversion audit for any homepage or landing page. Use when someone
  asks to "review my homepage," "audit my landing page," "why isn't my page converting,"
  "check my website," "improve my homepage," or wants feedback on their marketing
  page.
metadata:
  openclaw:
    emoji: 📄
